...
.. code::
    ...
    build.gradle 
        ...
        application {
            ...
            mainClassName    = 'unibo.disi.cargoserviceM2MGui.CargoserviceM2MGuiApplication'
        }		
...
-------------------------------
M2M-GUI application and run
-------------------------------

.. code::

    new package src\main\java\unibo\disi\cargoserviceM2MGui\controller
    M2MGuiController.java
    gradlew run
